...
-- AddForeignKey
ALTER TABLE "public"."BrandInfo" ADD CONSTRAINT "BrandInfo_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
